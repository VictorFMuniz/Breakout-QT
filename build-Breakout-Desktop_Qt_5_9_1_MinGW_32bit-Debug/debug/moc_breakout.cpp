...
struct qt_meta_stringdata_Breakout_t {
    QByteArrayData data[1];
    char stringdata0[9];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_Breakout_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Breakout_t qt_meta_stringdata_Breakout = {
    {
QT_MOC_LITERAL(0, 0, 8) // "Breakout"
...
const QMetaObject Breakout::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Breakout.data,
      qt_meta_data_Breakout,  qt_static_metacall, nullptr, nullptr}
};
...
void *Breakout::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Breakout.stringdata0))
